...
def train_mvgrl_and_generate_embeddings(run_id, train_loader, test_loader):
    ...
    encoder = MVGRLEncoder(in_channels, hidden_channels, out_channels, num_layers).to('cuda')
...
'''
MVGRL with BERT inputs
# Task: population Prediction, City: Beijing
# Metric     Average    Std Dev   
# ----------------------------------
# MAE        5714.6872 ± 351.7817
# RMSE       8536.1544 ± 394.4099
# R2         0.4483 ± 0.0503
# Task: house_price Prediction, City: Beijing
# Metric     Average    Std Dev   
# ----------------------------------
# MAE        16677.2727 ± 1963.4255
# RMSE       23569.4281 ± 2669.8001
# R2         0.6686 ± 0.0798

# Task: population Prediction, City: Shanghai
# Metric     Average    Std Dev   
# ----------------------------------
# MAE        13030.1313 ± 306.6708
# RMSE       17441.4792 ± 346.4666
# R2         0.1716 ± 0.0339
# Task: house_price Prediction, City: Shanghai
# Metric     Average    Std Dev   
# ----------------------------------
# MAE        18027.1486 ± 348.7299
# RMSE       25266.5783 ± 669.2990
# R2         0.1866 ± 0.0482
'''